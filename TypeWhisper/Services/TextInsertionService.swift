...
final class TextInsertionService {
    ...
    func insertText(
        ...
        // Let clipboard managers identify this as generated content instead of an intentional user copy.
        pasteboard.setData(Data(), forType: .init("org.nspasteboard.AutoGeneratedType"))
        // Give users a unique app specific type they can use to manually filter in clipboard managers or otherwise.
        pasteboard.setData(Data(), forType: .init("com.typewhisper.SpeechTranscription"))
        simulatePaste()
